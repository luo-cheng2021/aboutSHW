...
cm_load(details::Block2DRefTy<T, BlockH, BlockW, NBlocks, Op> Res,
  ...
  Res = cm_load<T, BlockW, BlockH, NBlocks, transposed, vnni, L1H, L2H>(Desc.get_base_ptr(), Desc.get_width(), Desc.get_height(), Desc.get_pitch(), Desc.get_block_x(), Desc.get_block_y());
}
...
cm_prefetch(const lsc::block_2d_desc<T, NBlocks, BlockH, BlockW> &Desc,
  ...
  cm_prefetch<T, BlockW, BlockH, NBlocks, L1H, L2H>(Desc.get_base_ptr(), Desc.get_width(), Desc.get_height(), Desc.get_pitch(), Desc.get_block_x(), Desc.get_block_y());
}
...
cm_store(const lsc::block_2d_desc<T, 1, BlockH, BlockW> &Desc,
  ...
  cm_store<T, BlockW, BlockH, L1H, L2H>(Desc.get_base_ptr(), Desc.get_width(), Desc.get_height(), Desc.get_pitch(), Desc.get_block_x(), Desc.get_block_y(), Src);
}
...
cm_store(const lsc::block_2d_desc<T, 1, BlockH, BlockW> &Desc,
  ...
  cm_store(Desc, Src.select_all(), Pred);
}
